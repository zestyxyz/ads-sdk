...
describe('Initial load', () => {        
    test('The correct test page is currently loaded', async () => {
        await page.goto('http://localhost:8080/babylonjs/');
...
describe('Standard styles', () => {
    ...
    test('The wide standard banner is present', async () => {
        const banner2 = await page.evaluate(() => window.scene.meshes[5]._material._diffuseTexture.name);
    ...
    test('The square standard banner is present', async () => {
        const banner3 = await page.evaluate(() => window.scene.meshes[6]._material._diffuseTexture.name);
...
describe('Minimal styles', () => {
    test('The tall standard banner is present', async () => {
        const banner4 = await page.evaluate(() => window.scene.meshes[7]._material._diffuseTexture.name);
        expect(banner4).toBe('https://ipfs.io/ipns/lib.zesty.market/assets/zesty-banner-tall-minimal.png');
    })

    test('The wide standard banner is present', async () => {
        const banner5 = await page.evaluate(() => window.scene.meshes[8]._material._diffuseTexture.name);
        expect(banner5).toBe('https://ipfs.io/ipns/lib.zesty.market/assets/zesty-banner-wide-minimal.png');
    });
    
    test('The square standard banner is present', async () => {
        const banner6 = await page.evaluate(() => window.scene.meshes[9]._material._diffuseTexture.name);
...
describe('Transparent styles', () => {
    test('The tall transparent banner is present', async () => {
        const banner7 = await page.evaluate(() => window.scene.meshes[10]._material._diffuseTexture.name);
    ...
    test('The wide transparent banner is present', async () => {
        const banner8 = await page.evaluate(() => window.scene.meshes[11]._material._diffuseTexture.name);
    ...
    test('The square transparent banner is present', async () => {
        const banner9 = await page.evaluate(() => window.scene.meshes[12]._material._diffuseTexture.name);
